...
class _MenuState extends State<Menu>{
  ...
  text: TextSpan(
    ...
    body: Column(
          children: <Widget>[
            Container(
              child: Text("Aqui é a atriz Saori Kido!"),
            ...
            , 
            child: Text("Iniciar jornada", style: TextStyle(color: Colors.yellow, fontSize: 25)),
            style: TextButton.styleFrom(backgroundColor:   Color.fromARGB(255, 196, 43, 223))),
